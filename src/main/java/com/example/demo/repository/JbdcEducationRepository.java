...
public class JbdcEducationRepository implements EducationRepository {
    ...
    public int save(Education education) {
        return jdbcTemplate.update("INSERT INTO EDUCATION (career_id, education_level, years_of_schooling, education_description) VALUES(?,?,?,?)",
        new Object[] {education.getCareerId(), education.getEducationLevel(), education.getYearsOfSchooling(), education.getEducationDescription()});
    }

    @Override
    public int update(Education education) {
        return jdbcTemplate.update("UPDATE EDUCATION SET education_level=?, years_of_schooling=?, education_description=? WHERE education_id=?",
        new Object[] { education.getEducationLevel(), education.getYearsOfSchooling(), education.getEducationDescription()});
   }
